        ...
        return(
            <div>
                ...
                <div>
                 ...
                 <button className="btn btn-success" style={{marginLeft:'16%',color:'#000000',backgroundColor:'#D3D3D3'}}><a href="/add"  style={{textDecoration:'none',color:'#000000',}} >Add NewVehicle</a></button>
                        ...
                        <tbody>
                            {this.state.posts.map((posts,index)=>(
                                    <tr>
                                        ...
                                        <td>{posts.year}</td>
                                        <td>
                                            <a className="btn" style={{color:'#000000',backgroundColor:'#D3D3D3'}} href={`/update/${posts.id}`}>
